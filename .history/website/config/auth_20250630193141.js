...
class AuthManager {
    ...
    /**
     * Update user profile (simplified version for current user)
     */
    ...
    /**
     * Change password (simplified version for current user)
     */
    async changePassword(currentPassword, newPassword) {
        try {
            ...
            // Log activity
            this.logActivity('password_change', { userId: this.currentUser.id });
    ...
    async updateAvatar(avatarData) {
        try {
            ...
            // Log activity
            this.logActivity('avatar_update', { userId: this.currentUser.id });
            ...
            return { success: false, message: 'Đã xảy ra lỗi khi cập nhật avatar' };
        }
    }
