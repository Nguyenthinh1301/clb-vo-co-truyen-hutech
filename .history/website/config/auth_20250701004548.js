...
class AuthManager {
    ...
    updateHeaderForLoggedInUser() {
        // Show logged-in user menu and hide guest menu
        ...
        if (userNameElement && this.currentUser) {
            userNameElement.textContent = this.currentUser.fullName || this.currentUser.username || 'Người dùng';
        }
        ...
        if (userAvatarElement) {
            if (this.currentUser && this.currentUser.avatar) {
                ...
                // Use default avatar with proper path based on current location
                const currentPath = window.location.pathname;
                let avatarPath = 'assets/images/default-avatar.svg';
    ...
    initializeUserDropdown() {
        ...
        if (userDropdownBtn && userDropdownMenu && !userDropdownBtn.dataset.initialized) {
            ...
            userDropdownBtn.dataset.initialized = 'true';
        }
    }
}
