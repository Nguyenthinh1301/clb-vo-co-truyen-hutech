...
class AuthManager {
    ...
    async init() {
        ...
        awai    updateHeaderForLoggedInUser() {
        // Show logged in menu
        ...
        if (authItems.length > 0 && this.currentUser) {
            ...
            if (!userMenu) {
                ...
                userMenu.innerHTML = `
                    <a href="#" class="nav-link user-info">
                        ...
                        <span id="headerUserName">${this.currentUser.name}</span>
                    </a>
                    <div class="user-dropdown">
                        <a href="#" onclick="Auth.navigateToProfile()">
                            <i class="fas fa-user-circle"></i> Hồ sơ
                        </a>
                        <a href="#" onclick="Auth.navigateToDashboard()">
