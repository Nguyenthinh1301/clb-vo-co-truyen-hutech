...
class AuthManager {
    ...
    updateHeaderForLoggedInUser() {
        ...
        // Update user name and avatar in profile dropdown
        const profileName = document.querySelector('.profile-name');
        const profileAvatar = document.querySelector('.profile-avatar');
        
        if (profileName && this.currentUser) {
            profileName.textContent = this.currentUser.fullName || this.currentUser.username;
        }
        
        if (profileAvatar && this.currentUser && this.currentUser.profileImage) {
            profileAvatar.src = this.currentUser.profileImage;
        }

        // Show logged-in user menu (backward compatibility)
        ...
        // Update user name and avatar (backward compatibility)
    ...
    updateHeaderForLoggedOutUser() {
        ...
        // Show guest menu (backward compatibility)
        const guestItems = document.querySelectorAll('.guest-only');
        const loggedInItems = document.querySelectorAll('.logged-in-only');
